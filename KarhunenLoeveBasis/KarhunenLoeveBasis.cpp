...
// KarhunenLoeveBasis.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKarhunenLoeveBasisApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKarhunenLoeveBasisApp

CKarhunenLoeveBasisApp::CKarhunenLoeveBasisApp()
{
...
// Единственный объект CKarhunenLoeveBasisApp

CKarhunenLoeveBasisApp theApp;


// Инициализация CKarhunenLoeveBasisApp

BOOL CKarhunenLoeveBasisApp::InitInstance()
{
